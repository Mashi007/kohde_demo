...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Gráfico de Tendencia de Mermas por Servicio */}
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 rounded-xl border border-slate-700 shadow-xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold flex items-center gap-3 mb-2">
              ...
              {Object.entries(mermasTendenciaServicioEstadisticas.servicios_con_exceso).map(([servicio, datos]) => (
                <div key={servicio} className="bg-slate-900/70 p-4 rounded-lg border border-slate-600">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-400">Merma en peso:</span>
                      <span className="text-slate-200 font-semibold">{(datos.peso_total_exceso || 0).toFixed(2)} kg</span>
                    </div>
                    <div className="flex justify-between">
